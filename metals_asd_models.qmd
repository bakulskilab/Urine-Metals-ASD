...
## One batch only (largest)

```{r batch_sens1}
model_fit_sens <- function(pd, logistic=F){
  asd.res <- list()
  ntd.res <- list()
  
  for(met in metals){
    sub = pd %>% filter(Analyte.Code==met) %>% filter(LOD!=min(LOD))
...
earli.resT2.sens <- model_fit_sens(metals.earli.T2)
earli.resT3.sens <- model_fit_sens(metals.earli.T3)
marbles.resT2.sens <- model_fit_sens(metals.marbles.T2)
marbles.resT3.sens <- model_fit_sens(metals.marbles.T3)


# test <- metals.earli.T2 %>% filter(Analyte.Code=='Antimony') %>% filter(LOD!=min(LOD))
# test$overLOD <- test$Concentration > test$LOD
# table(test$asd, test$MomEdu)
# table(test$asd, test$coi_gender)
# table(test$overLOD, test$MomEdu)
# table(test$overLOD, test$coi_gender)
# table(test$asd, test$overLOD)

earli.asd.T2.sens <- extract_res(earli.resT2.sens$asd, metals.earli.T2)
earli.ntd.T2.sens <- extract_res(earli.resT2.sens$ntd, metals.earli.T2)
earli.asd.T3.sens <- extract_res(earli.resT3.sens$asd, metals.earli.T3)
earli.ntd.T3.sens <- extract_res(earli.resT3.sens$ntd, metals.earli.T3)

marbles.asd.T2.sens <- extract_res(marbles.resT2.sens$asd, metals.marbles.T2)
marbles.ntd.T2.sens <- extract_res(marbles.resT2.sens$ntd, metals.marbles.T2)
marbles.asd.T3.sens <- extract_res(marbles.resT3.sens$asd, metals.marbles.T3)
marbles.ntd.T3.sens <- extract_res(marbles.resT3.sens$ntd, metals.marbles.T3)


res.earli.T2.asd.sens <- process_res(earli.asd.T2.sens, "EARLI", IQRs.T2)
res.earli.T2.ntd.sens <- process_res(earli.ntd.T2.sens, "EARLI", IQRs.T2)
res.earli.T3.asd.sens <- process_res(earli.asd.T3.sens, "EARLI", IQRs.T3)
res.earli.T3.ntd.sens <- process_res(earli.ntd.T3.sens, "EARLI", IQRs.T3)

res.marbles.T2.asd.sens <- process_res(marbles.asd.T2.sens, "MARBLES", IQRs.mT2)
res.marbles.T2.ntd.sens <- process_res(marbles.ntd.T2.sens, "MARBLES", IQRs.mT2)
res.marbles.T3.asd.sens <- process_res(marbles.asd.T3.sens, "MARBLES", IQRs.mT3)
res.marbles.T3.ntd.sens <- process_res(marbles.ntd.T3.sens, "MARBLES", IQRs.mT3)


res.asdT2.sens <- binding(res.earli.T2.asd.sens, res.marbles.T2.asd.sens)
res.asdT3.sens <- binding(res.earli.T3.asd.sens, res.marbles.T3.asd.sens)
res.ntdT2.sens <- binding(res.earli.T2.ntd.sens, res.marbles.T2.ntd.sens)
res.ntdT3.sens <- binding(res.earli.T3.ntd.sens, res.marbles.T3.ntd.sens)
...
meta.asdT2.sens <- meta(res.asdT2.sens)
meta.asdT3.sens <- meta(res.asdT3.sens)
meta.ntdT2.sens <- meta(res.ntdT2.sens)
meta.ntdT3.sens <- meta(res.ntdT3.sens)

tab.asdT2.sens <- meta.res.tab(meta.asdT2.sens)
tab.asdT3.sens <- meta.res.tab(meta.asdT3.sens)
tab.ntdT2.sens <- meta.res.tab(meta.ntdT2.sens)
tab.ntdT3.sens <- meta.res.tab(meta.ntdT3.sens)

fdrT2 <- p.adjust(p=c(tab.asdT2.sens[,10],tab.ntdT2.sens[,10]), method="BH") %>% signif(2)
fdrT3 <- p.adjust(p=c(tab.asdT3.sens[,10],tab.ntdT3.sens[,10]), method="BH") %>% signif(2)

tab.asdT2.sens$FDR <- fdrT2[1:17]
tab.ntdT2.sens$FDR <- fdrT2[18:34]
tab.asdT3.sens$FDR <- fdrT3[1:17]
tab.ntdT3.sens$FDR <- fdrT3[18:34]
...
compiled.tab.sens <- list(asdT2=tab.asdT2.sens, asdT3=tab.asdT3.sens, ntdT2=tab.ntdT2.sens, ntdT3=tab.ntdT3.sens)

write.xlsx(compiled.tab.sens, file=paste0(here(),'/../Tables/meta_estimates_sensivity_tables.xlsx'))
...
model_fit_sens2 <- function(pd){
  ...
  for(met in metals){
    ...
    if(mod.type[met] == 'continuous'){
        fit.asdglm = glm(asd ~ Concentration_imp_sg_log2 + MomEdu + coi_gender + maternal_age + GA_deliv_wks + batch, 
               data=asd, family=binomial)
        fit.asd = probratio(fit.asdglm, scale='log', method='delta')
        
        fit.ntdglm = glm(asd ~ Concentration_imp_sg_log2 + MomEdu + coi_gender + maternal_age + GA_deliv_wks + batch, 
                 data=ntd, family=binomial)
        fit.ntd = probratio(fit.ntdglm, scale='log', method='delta')
    }else{
      asd$overLOD <- asd$Concentration > asd$LOD
...
write.xlsx(compiled.tab.sens2, file=paste0(here(),'/../Tables/meta_estimates_sensivity_tables_adjust.xlsx'))
